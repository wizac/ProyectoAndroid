...
import com.example.admin.proyectoandroid.menu.*;
import com.example.admin.proyectoandroid.seccionesMenu.*;
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                fragment = new Menu_favoritos();
                break;
            case 2:
                fragment = new Menu_progreso();
                break;
            case 3:
                fragment = new Menu_extras();
                break;
